        ...
        if($vw_fitness_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-fitness'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
                    <?php if ( have_posts() ) :
                    /* Start the Loop */
                    ...
                    ?>
                    <?php if( get_theme_mod( 'vw_fitness_blog_pagination_hide_show',true) == 1) { ?>
                        <div class="navigation">
                          <?php vw_fitness_blog_posts_pagination(); ?>
